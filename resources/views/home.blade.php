    ...
    <div class="jumbotron">
        <div class="container">
            ...
            @else
                ...
                <p>Learn not to forget to buy what is needed at your home</p>
                <p>
                    <button class="btn-secondary" onclick="window.location.href='{{route('login')}}'">Login</button>
                </p>
                <p>
                    <button class="btn-secondary" onclick="window.location.href='{{route('register')}}'">Register
                    </button>
                </p>
            @endif
        </div>
                ...
                <div class="container marketing">
                    <div class="row justify-content-center" align="center">
                        ...
                        <div class="col-lg-4">
                            ...
                            <p>
                                <button class="btn btn-secondary"
                                        onclick="window.location.href='{{route('listRecipe')}}'">Create your shopping
                                    list
                                </button>
                            </p>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <img class="rounded-circle" alt="Generic placeholder image" src="images/category.jpg"
                                 width="149" height="149">
                ...
                <div class="container marketing">
                    <div class="row justify-content-center" align="center">
                        <div class="col-lg-4">
                            ...
                            <p>
                                <button class="btn btn-secondary" onclick="window.location.href='#product'">Details
                                </button>
                            </p>
                        </div>
                        <div class="col-lg-4">
                            ...
                            <p>Discover your shopping list</p>
                            <p>
                                <button class="btn btn-secondary" onclick="window.location.href='#shopping'">Details
                                </button>
                            </p>
                        </div>
                        <div class="col-lg-4">
                            ...
                            <p>Discover your recipes</p>
                            <p>
                                <button class="btn btn-secondary" onclick="window.location.href='#recipe'">Details
                                </button>
                            </p>
                        </div>
                        <div class="col-lg-4">
                            ...
                            <p>Discover your categories</p>
                            <p>
                                <button class="btn btn-secondary" onclick="window.location.href='#category'">Details
                                </button>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-5 pull-md-7">
                            <figure>
                                <img class="img-fluid mx-auto" src="images/listecourse.jpg" alt="500x500"
                                     style="width: 500px; height: 500px;">
                    ...
                    <div class="row" id="recipe">
                        ...
                        <div class="col-md-5">
                            <figure>
                                <img class="img-fluid mx-auto" src="images/listerecipe.jpg" alt="500x500"
                                     style="width: 500px; height: 500px;">
                    ...
                    <div class="row" id="category">
                        <div class="col-md-5">
                            <figure>
                                <img class="img-fluid mx-auto" src="images/listecategory.jpg" alt="500x500"
                                     style="width: 500px; height: 500px;">
